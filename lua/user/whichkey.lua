...
local mappings = {
  ...
  d = { '<cmd>lua require("telescope.builtin").find_files( { cwd = vim.fn.expand("%:p:h") })<cr>', 'Telescope Here' },
  p = {
    name = "Packer",
  ...
  f = {
    ...
    v = { "<cmd>:Vex 20<cr>", "Vertical Browser" },
    b = { "<cmd>Telescope file_browser path=%:p:h select_buffer=true<cr>", "Browser" },
    g = { "<cmd>lua require('telescope.builtin').live_grep()<cr>", "Grep"},
    f = { "<cmd>lua require('telescope.builtin').git_files()<cr>", "Git Directory", },
    h = { "<cmd>lua require('telescope.builtin').old_files()<cr>", "Find Help" },
